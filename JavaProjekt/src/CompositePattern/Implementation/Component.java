        ...
        extends IComponent
{
    ...
    {
        return String.format("%1$s %2$s", getType(), this.uuid);
    }
}
        ...
        extends IComponent<TComposite>
{
    ...
    public void MoveTo(TComposite targetComposite)
    {
        ...
        if ((componentToMove instanceof IComposite<TComposite> ? (IComposite<TComposite>)componentToMove : null) == null ? null : ((componentToMove instanceof IComposite<TComposite> ? (IComposite<TComposite>)componentToMove : null).IsRoot()) != null ? (componentToMove instanceof IComposite<TComposite> ? (IComposite<TComposite>)componentToMove : null).IsRoot() : false)
        {
        ...
        if (tempVar)
        {
            compositeToMove.ExecuteThreadSave(() -> compositeToMove.SelectNotBoundetComponents().ToList().ForEach(boundetComponent -> SwapParants(boundetComponent, boundetComponent.Parent, oldParentComposite)));
        }
    ...
    public boolean IsManaged()
    {
        ...
        ? (IComposite<TComposite>)this : null) == null
        ? null : ((this instanceof IComposite<TComposite>
        ? (IComposite<TComposite>)this : null).IsRoot()) != null
        ? (this instanceof IComposite<TComposite>
        ? (IComposite<TComposite>)this : null).IsRoot() : false);
    }
